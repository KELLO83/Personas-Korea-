...
from experiments.hobby_recommender_ml.hobby_recommender.model import LightGCN, XSimGCL, build_normalized_adjacency, info_nce_loss
...
def test_xsimgcl_contrastive_loss_deduplicates_batch_ids(monkeypatch) -> None:
    ...
    monkeypatch.setattr("experiments.hobby_recommender_ml.hobby_recommender.model.info_nce_loss", _fake_info_nce)
