...
@dataclass(frozen=True)
class PathConfig:
    edge_csv: Path = Path("experiments/hobby_recommender_ml/data/person_hobby_edges.csv")
    person_context_csv: Path = Path("experiments/hobby_recommender_ml/data/person_context.csv")
    artifact_dir: Path = Path("experiments/hobby_recommender_ml/artifacts")
    train_edges: Path = Path("experiments/hobby_recommender_ml/artifacts/train_edges.csv")
    validation_edges: Path = Path("experiments/hobby_recommender_ml/artifacts/validation_edges.csv")
    test_edges: Path = Path("experiments/hobby_recommender_ml/artifacts/test_edges.csv")
    person_mapping: Path = Path("experiments/hobby_recommender_ml/artifacts/person_mapping.json")
    hobby_mapping: Path = Path("experiments/hobby_recommender_ml/artifacts/hobby_mapping.json")
    checkpoint: Path = Path("experiments/hobby_recommender_ml/artifacts/lightgcn_hobby.pt")
    metrics: Path = Path("experiments/hobby_recommender_ml/artifacts/metrics.json")
    vocabulary_report: Path = Path("experiments/hobby_recommender_ml/artifacts/vocabulary_report.json")
    config_snapshot: Path = Path("experiments/hobby_recommender_ml/artifacts/config_snapshot.yaml")
    sample_recommendations: Path = Path("experiments/hobby_recommender_ml/artifacts/sample_recommendations.json")
    candidates_sample: Path = Path("experiments/hobby_recommender_ml/artifacts/candidates_sample.json")
    hobby_profile: Path = Path("experiments/hobby_recommender_ml/artifacts/hobby_profile.json")
    leakage_audit: Path = Path("experiments/hobby_recommender_ml/artifacts/leakage_audit.json")
    fallback_usage: Path = Path("experiments/hobby_recommender_ml/artifacts/fallback_usage.json")
    score_normalization: Path = Path("experiments/hobby_recommender_ml/artifacts/score_normalization.json")
    provider_contribution: Path = Path("experiments/hobby_recommender_ml/artifacts/provider_contribution.json")
    hobby_aliases: Path = Path("experiments/hobby_recommender_ml/artifacts/hobby_aliases.json")
    hobby_taxonomy: Path = Path("experiments/hobby_recommender_ml/artifacts/hobby_taxonomy.json")
    canonical_hobby_examples: Path = Path("experiments/hobby_recommender_ml/artifacts/canonical_hobby_examples.json")
    rerank_metrics: Path = Path("experiments/hobby_recommender_ml/artifacts/rerank_metrics.json")
    reranker_weights: Path = Path("experiments/hobby_recommender_ml/artifacts/reranker_weights.json")
    rerank_sample: Path = Path("experiments/hobby_recommender_ml/artifacts/rerank_sample.json")
