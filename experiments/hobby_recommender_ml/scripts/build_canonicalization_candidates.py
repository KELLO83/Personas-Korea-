...
from experiments.hobby_recommender_ml.hobby_recommender.data import load_hobby_taxonomy, load_person_hobby_edges, normalize_hobby_name, save_json
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", type=Path, default=Path("experiments/hobby_recommender_ml/data/person_hobby_edges.csv"))
    parser.add_argument("--taxonomy", type=Path, default=Path("experiments/hobby_recommender_ml/configs/hobby_taxonomy.json"))
    parser.add_argument("--output", type=Path, default=Path("experiments/hobby_recommender_ml/artifacts/canonicalization_candidates.json"))
