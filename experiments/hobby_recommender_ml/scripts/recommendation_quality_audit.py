...
from experiments.hobby_recommender_ml.hobby_recommender.recommend import (
    compute_lightgcn_embeddings,
    merge_candidates_by_hobby,
)
from experiments.hobby_recommender_ml.hobby_recommender.rerank import build_reranker_config, merge_stage1_candidates, rerank_candidates
from experiments.hobby_recommender_ml.scripts.evaluate_reranker import (
    _expect_mapping,
    _known_from_edges,
...
def _load_hobby_category_map(configured_path: Path) -> dict[str, str]:
    payload: object = {}
    fallback_path = Path("experiments/hobby_recommender_ml/artifacts/hobby_taxonomy.json")
