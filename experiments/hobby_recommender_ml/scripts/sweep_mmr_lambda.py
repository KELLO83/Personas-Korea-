...
from experiments.hobby_recommender_ml.hobby_recommender.baseline import (
...
from experiments.hobby_recommender_ml.hobby_recommender.data import PersonContext, load_json, load_person_contexts, save_json
...
from experiments.hobby_recommender_ml.hobby_recommender.recommend import merge_candidates_by_hobby, normalize_candidate_scores
from experiments.hobby_recommender_ml.hobby_recommender.rerank import (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-json", type=Path, default=Path("experiments/hobby_recommender_ml/artifacts/mmr_sweep.json"))
    parser.add_argument("--output-plot", type=Path, default=Path("experiments/hobby_recommender_ml/artifacts/mmr_pareto.png"))
