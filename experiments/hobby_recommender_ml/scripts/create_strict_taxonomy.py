...
Usage:
    python experiments/hobby_recommender_ml/scripts/create_strict_taxonomy.py
"""
...
REVIEW_PATH = Path("experiments/hobby_recommender_ml/configs/hobby_taxonomy_review.json")
LOOSE_BACKUP = Path("experiments/hobby_recommender_ml/configs/hobby_taxonomy_review_loose.json")
