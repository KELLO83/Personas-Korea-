...
# 프로젝트 루트를 sys.path에 추가 (experiments/hobby_recommender_ml/scripts/에서 2단계 위 = 프로젝트 루트)
ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
if ROOT not in sys.path:
    sys.path.insert(0, ROOT)

from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_popularity_counts, build_cooccurrence_counts
