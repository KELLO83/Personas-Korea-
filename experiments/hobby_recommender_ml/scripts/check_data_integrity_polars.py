...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-dir", type=Path, default=Path("experiments/hobby_recommender_ml/data"))
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("experiments/hobby_recommender_ml/artifacts/experiments/data_integrity/polars_data_integrity.json"),
    )
