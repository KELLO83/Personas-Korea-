...
Usage (legacy only):
    python -m experiments.hobby_recommender_ml.scripts.tune_ranker_regularization
    python experiments/hobby_recommender_ml/scripts/tune_ranker_regularization.py
"""
...
from experiments.hobby_recommender_ml.hobby_recommender.data import load_json, load_person_contexts, save_json  # noqa: E402
from experiments.hobby_recommender_ml.hobby_recommender.metrics import summarize_ranking_metrics  # noqa: E402
from experiments.hobby_recommender_ml.hobby_recommender.ranker import LightGBMRanker, build_ranker_dataset  # noqa: E402
from experiments.hobby_recommender_ml.hobby_recommender.recommend import merge_candidates_by_hobby, normalize_candidate_scores  # noqa: E402
from experiments.hobby_recommender_ml.hobby_recommender.rerank import HobbyCandidate, build_reranker_config, merge_stage1_candidates  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("experiments/hobby_recommender_ml/artifacts"))
...
def train_and_evaluate(
    ...
    from experiments.hobby_recommender_ml.hobby_recommender.rerank import build_rerank_features, rerank_candidates
