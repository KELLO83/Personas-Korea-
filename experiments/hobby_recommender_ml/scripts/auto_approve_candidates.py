...
from experiments.hobby_recommender_ml.hobby_recommender.data import save_json
...
def parse_args() -> argparse.Namespace:
    ...
    _ = parser.add_argument(
        "--candidates",
        type=Path,
        default=Path("experiments/hobby_recommender_ml/artifacts/canonicalization_candidates.json"),
    )
    _ = parser.add_argument(
        "--output",
        type=Path,
        default=Path("experiments/hobby_recommender_ml/configs/hobby_taxonomy_review.json"),
    )
