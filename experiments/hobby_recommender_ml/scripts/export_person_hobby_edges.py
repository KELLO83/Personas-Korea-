...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=Path("experiments/hobby_recommender_ml/data/person_hobby_edges.csv"))
    parser.add_argument("--context-output", type=Path, default=Path("experiments/hobby_recommender_ml/data/person_context.csv"))
