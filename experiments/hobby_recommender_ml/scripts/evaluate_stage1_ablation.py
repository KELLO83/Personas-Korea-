...
from experiments.hobby_recommender_ml.hobby_recommender.data import load_json, load_person_contexts, save_json
from experiments.hobby_recommender_ml.hobby_recommender.metrics import summarize_ranking_metrics
from experiments.hobby_recommender_ml.hobby_recommender.model import LightGCN, build_normalized_adjacency, choose_device
from experiments.hobby_recommender_ml.hobby_recommender.recommend import Candidate, compute_lightgcn_embeddings, merge_candidates_by_hobby
from experiments.hobby_recommender_ml.scripts.evaluate_reranker import _expect_mapping, _known_from_edges, _normalization_method, _provider_candidates, _read_indexed_edges, _safe_torch_load
...
def _build_popularity_counts_cached(train_edges: list[tuple[int, int]]) -> Counter[int]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_popularity_counts
...
def _build_cooccurrence_counts_cached(train_edges: list[tuple[int, int]]) -> dict[int, Counter[int]]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_cooccurrence_counts
...
def _build_bm25_itemknn_counts_cached(train_edges: list[tuple[int, int]]) -> dict[int, dict[int, float]]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_bm25_itemknn_counts
...
def _build_idf_cooc_counts_cached(train_edges: list[tuple[int, int]]) -> dict[int, dict[int, float]]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_idf_weighted_cooccurrence_counts
...
def _build_pop_capped_counts_cached(train_edges: list[tuple[int, int]]) -> dict[int, dict[int, float]]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_pop_capped_cooccurrence_counts
...
def _build_jaccard_counts_cached(train_edges: list[tuple[int, int]]) -> dict[int, dict[int, float]]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_jaccard_itemknn_counts
...
def _build_pmi_counts_cached(train_edges: list[tuple[int, int]]) -> dict[int, dict[int, float]]:
    from experiments.hobby_recommender_ml.hobby_recommender.baseline import build_pmi_itemknn_counts
