...
from GNN_Neural_Network.gnn_recommender.phase6 import Phase6ExperimentSpec, validate_phase6_spec
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("GNN_Neural_Network/artifacts/phase6/manifest.json"),
    )
