...
5. **KURE dense embedding 기반 MMR 재평가**
   ...
   - Phase 2.5 default decision closure 이후 별도 Phase 5 실험군으로 수행한다.
   - closed Phase 2.5 default를 고정 baseline으로 사용한다.
...
- current default의 accuracy 우위를 과도하게 훼손하지 않으면서 `coverage@10`, `novelty@10`, `intra_list_diversity@10` 중 최소 2개를 개선할 수 있는지 확인한다.
