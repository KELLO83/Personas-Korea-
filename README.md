...
자세한 구현 항목은 `CHECKLIST.md`에서 확인할 수 있습니다. 기능 요구사항과 설계 배경은 `PRD.md`에 정리되어 있습니다.
...
| 화면 | Streamlit, Next.js React(신규 병행 프론트) |
...
React 프론트는 기존 Streamlit을 삭제하지 않고 `frontend/`에서 병행 실행합니다. FastAPI 서버는 먼저 `:8000`에서 실행되어 있어야 합니다.
